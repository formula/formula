(function (global, factory) {
  ...
  */
  ...
  function substituteAll(
    ...
    return reduce(
      keys(locals),
      function (p, v) { return substitute(p, ("" + start + v + end), locals[v]); },
      content
    );
  }
  ...
  ************************* */
  ...
  function query(data, query) {
    ...
    var comparisonGroup = function (row, list, key, op) {
      ...
      return op.apply(
        void 0, map(list[key], function (d) { return op.apply(void 0, map(keys(d), function (e) { return comparator(d, e)(row); })); })
      );
    };

    var composeQuery = function (list) { return reduce(
        keys(list),
        function (funcs, key) { return funcs.concat(function (row) { return branch(
              key === "$and",
  ...
  function changed(a, b) {
    ...
    return unique(
      keysA.filter(function (n) { return a[n] !== b[n]; }).concat(keysB.filter(function (n) { return a[n] !== b[n]; }))
    );
  }
  ...
  function ref$1(top, bottom) {
    ...
    return {
      ...
      get rows() {
        return unique(
          Array.apply(getTop(), Array(1 + (getBottom() - getTop()))).map(function (x, y) { return index2row(y + getTop()); }
          )
        );
      }
    };
  ...
  exports.isArray = isarray;
  exports.isarray = isarray;
  exports.ISASYNCFUNCTION = isfunction$1;
  exports.isAsyncFunction = isfunction$1;
  exports.isasyncfunction = isfunction$1;
