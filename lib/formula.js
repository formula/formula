...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) : typeof define === 'function' && define.amd ? define(['exports'], factory) : factory(global.Formula = global.Formula || {});
})(void 0, function (exports) {
  'use strict'; // Copyright 2015-2018 FormBucket LLC
  ...
  */
  ...
  function and() {
    for (var _len3 = arguments.length, criteria = new Array(_len3), _key3 = 0; _key3 < _len3; _key3++) {
    ...
    return reduce(criteria, function (acc, item) {
      ...
      var val = isfunction(item) ? item() : item; // return `#VALUE!` if not true, false, 1 or 0.
  ...
  function branch() {
    for (var _len4 = arguments.length, cases = new Array(_len4), _key4 = 0; _key4 < _len4; _key4++) {
  ...
  function assign(initial) {
    ...
    for (var _len5 = arguments.length, list = new Array(_len5 > 1 ? _len5 - 1 : 0), _key5 = 1; _key5 < _len5; _key5++) {
      list[_key5 - 1] = arguments[_key5];
    }
  ...
  var WALKERCONFIGDEFAULT = {
    ...
    renderOperator: function renderOperator(config, _ref, depth) {
      ...
      return branch(operands.length == 1, function () {
        return "".concat(branch(subtype == "prefix-minus", config.renderMINUS(config, depth), subtype == "prefix-plus", config.renderPLUS(config, depth))).concat(walk(config, operands[0], depth + 1));
      }, operands.length === 2, function () {
        return "".concat(walk(config, operands[0], depth + 1)).concat(branch(subtype == "infix-eq", config.renderEQ(config, {
          operands: operands
  ...
  var WALKERCONFIGFP = assign(WALKERCONFIGDEFAULT, {
    renderOperator: function renderOperator(config, _ref7, depth) {
      ...
      return branch(subtype == "prefix-minus", "MINUS(".concat(walk(config, operands[0], depth + 1), ")"), subtype == "prefix-plus", "PLUS(".concat(walk(config, operands[0], depth + 1), ")"), subtype == "infix-eq", runFunc("EQ", config, {
        operands: operands,
        subtype: subtype
  ...
  var WALKERCONFIGJS = assign(WALKERCONFIGFP, {
    ...
    renderFunctionBegin: function renderFunctionBegin(config, f) {
      return "Formula.".concat(WALKERCONFIGFP.renderFunctionBegin(config, f));
    },
  ...
  var WALKER = function WALKER() {
    var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : WALKERCONFIGDEFAULT;
    return function (ast) {
  ...
  function compile(exp) {
    ...
    var walk2 = WALKER(assign(WALKERCONFIGJS, {
  ...
  function run(exp) {
    ...
    if (!istext(exp)) return error$2.na; // check cached and shortcut if appropriate.
    ...
    var locals = assign({}, params); // Default get for plain object.
  ...
  function SWITCH(targetValue) {
    ...
    var defaultClause = argc % 2 === 0 ? null : (_ref9 = (arguments.length <= 1 ? 0 : arguments.length - 1) - 1 + 1, _ref9 < 1 || arguments.length <= _ref9 ? undefined : arguments[_ref9]);
    ...
    return defaultClause || error$2.na;
  } // NOT negates a `value`
  ...
  function or() {
    for (var _len6 = arguments.length, criteria = new Array(_len6), _key6 = 0; _key6 < _len6; _key6++) {
    ...
    return reduce(criteria, function (acc, item) {
      ...
      var value = isfunction(item) ? item() : item; // Return true when value is true or 1.
  ...
  function mod(a, b) {
    if (!isnumber(a) || !isnumber(b)) return error$2.value;
    return a % b;
  ...
  function substituteAll(content, locals) {
    ...
    return reduce(keys(locals), function (p, v) {
  ...
  function sum() {
    for (var _len9 = arguments.length, numbers = new Array(_len9), _key9 = 0; _key9 < _len9; _key9++) {
  ...
  function average() {
    ...
    var v = sum.apply(void 0, arguments); // return sum when computed error.
  ...
  function filter(range) {
    for (var _len12 = arguments.length, filters = new Array(_len12 > 1 ? _len12 - 1 : 0), _key12 = 1; _key12 < _len12; _key12++) {
      filters[_key12 - 1] = arguments[_key12];
    }
  ...
  var filterTypes = {
    ...
    $in: function $in(queryVal) {
      return function (row, field) {
        return isarray(queryVal) && includes(row[field], queryVal);
      };
    },
    ...
    $text: function $text(queryVal) {
      return function (row, field) {
        return search(queryVal, row[field]) > 0;
      };
    },
  ...
  function query(data, query) {
    ...
    var comparator = function comparator(list, key) {
      return function (row) {
        return branch(isobject(list[key]), function () {
          return and.apply(void 0, _toConsumableArray(map(keys(list[key]), function (d) {
    ...
    var comparisonGroup = function comparisonGroup(row, list, key) {
      ...
      return op.apply(void 0, _toConsumableArray(map(list[key], function (d) {
        return op.apply(void 0, _toConsumableArray(map(keys(d), function (e) {
    ...
    var composeQuery = function composeQuery(list) {
      return reduce(keys(list), function (funcs, key) {
    ...
    return filter.apply(void 0, [data].concat(_toConsumableArray(map(funcs, function (filter) {
  ...
  function ipmt(rate, period, periods, present) {
    ...
    var payment = pmt(rate, periods, present, future, type); // Compute interest
  ...
  function bin2dec(value) {
    ...
    if (valueAsString.length > 10) return error$2.NUM; // we subtract 512 when the leading number is 0.
  ...
  function oct2dec(octalNumber) {
    ...
    if (!/^[0-7]{1,10}$/.test(octalNumber)) return error$2.num; // Convert octal number to decimal number
  ...
  function sort(ref) {
    for (var _len14 = arguments.length, criteria = new Array(_len14 > 1 ? _len14 - 1 : 0), _key14 = 1; _key14 < _len14; _key14++) {
  ...
  function changed(a, b) {
    ...
    var keysA = keys(a),
        keysB = keys(b); // Find the unique set of properties comparing a to b and b to a.
  ...
  function clean(obj) {
    ...
    var keys$$ = keys(obj).filter(function (n) {
  ...
  function base(number, radix) {
    ...
    min_length = numbervalue(min_length); // if (fn.isAnyError(number, radix, min_length)) {
    //   return error.value;
    // }
  ...
  function ref$1(top, bottom) {
    ...
    return {
      ...
      hit: function hit(index) {
        ...
        if (index < 0) return error$2.na; // Check if value is inside range from top to bottom, inclusive.
