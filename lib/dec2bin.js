...
var _rept = _interopRequireDefault(require("./rept"));
...
function dec2bin(input, places) {
  ...
  if (!/^-?[0-9]{1,3}$/.test(number) || (0, _isnan.default)(number)) {
  ...
  if (typeof places === "undefined") {
    ...
    if (!/^-?[0-9]{1,3}$/.test(places) || (0, _isnan.default)(places)) {
      return _error.ERRORTYPES.value;
    ...
    return places >= result.length ? (0, _rept.default)("0", places - result.length) + result : _error.ERRORTYPES.num;
  }
}
