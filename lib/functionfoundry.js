...
function FILTER(range) {
  for (var _len6 = arguments.length, filters = Array(_len6 > 1 ? _len6 - 1 : 0), _key6 = 1; _key6 < _len6; _key6++) {
    filters[_key6 - 1] = arguments[_key6];
  }
...
function OR() {
  for (var _len9 = arguments.length, criteria = Array(_len9), _key9 = 0; _key9 < _len9; _key9++) {
    criteria[_key9] = arguments[_key9];
  }
...
function SORT(ref) {
  for (var _len10 = arguments.length, criteria = Array(_len10 > 1 ? _len10 - 1 : 0), _key10 = 1; _key10 < _len10; _key10++) {
    criteria[_key10 - 1] = arguments[_key10];
  }
...
function SWITCH() {
  return COND.apply(undefined, arguments);
};
