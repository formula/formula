...
(function (global, factory) {
  (typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? module.exports = factory() : typeof define === 'function' && define.amd ? define(factory) : global.Formula = factory();
})(this, function () {
  'use strict';
  ...
  */
  ...
  var filterTypes = {
    ...
    var comparator = function comparator(list, key) {
      return function (row) {
        return branch(isobject(list[key]), function () {
          return and.apply(undefined, _toConsumableArray(map(keys(list[key]), function (d) {
    ...
    var comparisonGroup = function comparisonGroup(row, list, key) {
      ...
      return op.apply(undefined, _toConsumableArray(map(list[key], function (d) {
        return op.apply(undefined, _toConsumableArray(map(keys(d), function (e) {
    ...
    return filter.apply(undefined, [data].concat(_toConsumableArray(map(funcs, function (filter) {
  ...
  var isWholeNumber = iswholenumber;
  var isInteger = iswholenumber;

  var concat = concatenate;

  var numberValue = numbervalue;

  var parseBool = parsebool;
