...
function or() {
  for (var _len3 = arguments.length, criteria = Array(_len3), _key3 = 0; _key3 < _len3; _key3++) {
    criteria[_key3] = arguments[_key3];
  }
...
function max() {
  for (var _len13 = arguments.length, list = Array(_len13), _key13 = 0; _key13 < _len13; _key13++) {
...
function npv(rate) {
  ...
  for (var _len14 = arguments.length, values = Array(_len14 > 1 ? _len14 - 1 : 0), _key14 = 1; _key14 < _len14; _key14++) {
    values[_key14 - 1] = arguments[_key14];
  }
...
function filter(range) {
  for (var _len15 = arguments.length, filters = Array(_len15 > 1 ? _len15 - 1 : 0), _key15 = 1; _key15 < _len15; _key15++) {
    filters[_key15 - 1] = arguments[_key15];
  }
...
function sort(ref) {
  for (var _len16 = arguments.length, criteria = Array(_len16 > 1 ? _len16 - 1 : 0), _key16 = 1; _key16 < _len16; _key16++) {
    criteria[_key16 - 1] = arguments[_key16];
  }
...
exports.isWholeNumber = iswholenumber;
exports.isInteger = iswholenumber;
exports.xor = xor;
exports.add = add;
