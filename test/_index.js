...
test('index', function(t) {
  ...
  t.ok( ff.combin, 'combin should be there')
  t.ok( ff.cos, 'cos should be there')
  t.ok( ff.cosh, 'cosh should be there')
  t.ok( ff.cot, 'cot should be there')
  t.ok( ff.coth, 'coth should be there')
  t.ok( ff.count, 'count should be there')
  t.ok( ff.csc, 'csc should be there')
  t.ok( ff.csch, 'csch should be there')
  ...
  t.ok( ff.decimal, 'decimal should be there')
  ...
  t.ok( ff.exp, 'exp should be there')
  t.ok( ff.fact, 'fact should be there')
  t.ok( ff.factdouble, 'factdouble should be there')
  t.ok( ff.filter, 'filter should be there')
  t.ok( ff.find, 'find should be there')
  t.ok( ff.fixed, 'fixed should be there')
  t.ok( ff.flatten, 'flatten should be there')
  t.ok( ff.floor, 'floor should be there')
  t.ok( ff.fv, 'fv should be there')
  t.ok( ff.gcd, 'gcd should be there')
  ...
  t.ok( ff.int, 'impt should be there')
  ...
  t.ok( ff.isnontext, 'isnontext should be there')
  ...
  t.ok( ff.lcm, 'lcm should be there')
  t.ok( ff.left, 'left should be there')
  t.ok( ff.len, 'len should be there')
  t.ok( ff.ln, 'ln should be there')
  t.ok( ff.log, 'log should be there')
  t.ok( ff.log10, 'log10 should be there')
  ...
  t.ok( ff.product, 'product should be there')
  t.ok( ff.proper, 'proper should be there')
  t.ok( ff.pv, 'pv should be there')
  t.ok( ff.quotient, 'quotient should be there')
  t.ok( ff.radians, 'radians should be there')
  t.ok( ff.rand, 'rand should be there')
  t.ok( ff.randbetween, 'randbetween should be there')
  ...
  t.ok( ff.slope, 'slope should be there')
  ...
  t.ok( ff.sumif, 'sumif should be there')
  t.ok( ff.surroundkeys, 'surroundkeys should be there')
  t.ok( ff.t, 't should be there')
